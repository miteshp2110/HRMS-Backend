...
const getUserDashboardData = async (req, res) => {
    ...
    try {
        ...
        const pendingLeaveSql = 'SELECT lr.id, lt.name as leave_type_name, lr.from_date as fromDate, lr.to_date as toDate FROM employee_leave_records lr JOIN user u ON lr.employee_id = u.id JOIN leave_types lt ON lr.leave_type = lt.id WHERE lr.employee_id = ? AND lr.primary_status IS NULL';
